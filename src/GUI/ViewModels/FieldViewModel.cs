...
namespace GroupDocs.Parser.GUI.ViewModels
{
    ...
    {
        private static readonly Brush VisibleBrush = new SolidColorBrush(Color.FromArgb(0x8F, 0x6F, 0xAF, 0xFF));
        private static readonly Brush HiddenBrush = new SolidColorBrush(Color.FromArgb(0x8F, 0xF5, 0xDE, 0xB3));
        private static readonly Point MinSize = new Point(5, 5);

        private readonly ISelectedFieldHost selectedFieldHost;
        private readonly BoolWrapper genVisibility;
        private double x;
        private double y;
            ...
            bool isHidden)
        {
            ...
            this.genVisibility = genVisibility;
            this.genVisibility.ValueChanged += OnGenVisibilityChanged;
            this.x = x;
            this.y = y;
            this.width = width;
            this.height = height;
        ...
        {
            genVisibility.ValueChanged -= OnGenVisibilityChanged;
        ...
        public bool IsHidden
        {
            ...
            set
            {
                if (UpdateProperty(ref isHidden, value))
                {
                    NotifyPropertyChanged(nameof(GenVisibility));
                }
            }
        }
        ...
        public Visibility GenVisibility
        {
            get => !IsHidden || genVisibility.Value ? Visibility.Visible : Visibility.Collapsed;
        }

        public Brush LabelBrush
        {
            get => IsHidden ? HiddenBrush : VisibleBrush;
        }

        public Brush BackgroundBrush
        {
            get => IsHidden ? Brushes.Wheat : Brushes.Transparent;
        }
        ...
        private void OnGenVisibilityChanged()
        {
            NotifyPropertyChanged(nameof(GenVisibility));
        }
    }
